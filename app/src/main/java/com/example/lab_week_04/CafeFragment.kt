...
class CafeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Siapkan daftar judul dan deskripsi dari strings.xml
        ...
        // Buat adapter dengan memberikan daftar deskripsi
        val adapter = CafeAdapter(childFragmentManager, lifecycle, tabContents)
        viewPager.adapter = adapter

        // Hubungkan TabLayout dengan ViewPager menggunakan daftar judul
